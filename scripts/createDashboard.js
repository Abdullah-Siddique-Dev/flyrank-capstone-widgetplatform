...
<head>
  ...
  <title>Lead Capture Platform — Dashboard</title>
...
<body class="bg-slate-50 text-slate-900 min-h-screen">
  <div id="root"></div>
  <script type="text/babel" src="/dashboard/app.js"></script>
</body>
</html>`;

const appJsContent = `const { useState, useEffect } = React;
...
fs.mkdirSync('public/dashboard', { recursive: true });
fs.writeFileSync('public/dashboard/index.html', htmlContent, 'utf8');
fs.writeFileSync('public/dashboard/app.js', appJsContent, 'utf8');
